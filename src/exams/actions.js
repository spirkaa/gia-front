...
export const examFilterSet = (filter) => actionWithPayload(EXAMS_FILTER_SET, filter)

export const examFilterClearPages = () => actionTrigger(EXAMS_FILTER_CLEAR_PAGES)

export const examPageSet = (page) => actionWithPayload(EXAMS_PAGE_SET, page)
