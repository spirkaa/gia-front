...
export const Home = () => (
  <Jumbotron>
    ...
    <p>
      ...
      экзаменов во время основного (май-июль) и дополнительного периодов (сентябрь)
      экзаменационной кампании 2019/2020 учебного года. Список организаторов,
      задействованных на ЕГЭ и ОГЭ.
    </p>
    <p>
