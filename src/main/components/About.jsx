  ...
  <div>
    ...
    <Row>
      ...
      <Col sm={10}>
        ...
        <p>
          <strong>[v2.14.0 от 2026.08.25]</strong> - Обновлены версии компонентов на
          клиенте.
        </p>
        <p>
          <strong>[v2.13.0 от 2026.06.06]</strong> - Традиционное обновление перед
          началом экзаменов. Обновлены версии компонентов. База очищена от неактуальных
          данных.
        </p>
        <p>
          <strong>[v2.12.0 от 2025.05.09]</strong> - Традиционное обновление перед
          началом экзаменов. На сервере обновлены версии PostgreSQL, Python, Django и
          пакетов. База очищена от неактуальных данных.
        </p>
        <p>
          <strong>[v2.9.0 от 2024.03.09]</strong> - Традиционное обновление перед
          началом экзаменов. Обновлены версии компонентов. База очищена от неактуальных
          данных.
        </p>
        <p>
          <strong>[v2.8.0 от 2023.05.27]</strong> - Традиционное обновление перед
        ...
        <p>
          ...
          нужно было прокручивать выпадающий список дат на странице
          &quot;Экзамены&quot;. Теперь даты сортируются в обратном порядке.
        </p>
        <p>
