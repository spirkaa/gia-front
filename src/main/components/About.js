    ...
    <Header header='О сайте' subHeader=' '/>
      ...
      <Row>
        ...
        <Col sm={10}>
          ...
          <p>
            <strong>[v2.3.1]</strong> 03.06.2018 - Заявление об ограничении ответственности
            теперь отображается на всех страницах.
          </p>
          <p>
            <strong>[v2.3.0]</strong> 26.05.2018 - Восстановлена работа парсера,
            база очищена от неактуальных данных и, соответственно, все подписки удалены.
          </p>
          <p>
            <strong>[v2.2.4]</strong> 01.09.2017 - Добавлен Дополнительный период ГИА,
            исправлены ошибки.
          </p>
          <p>
            <strong>[v2.2.3]</strong> Исправлена ошибка в функции обновления,
            когда в один день одновременно проходят экзамены 9 и 11 классов
            (19 июня, например).
          </p>
          <p>
            <strong>[v2.2.2]</strong> Чем дальше от начала ГИА,
