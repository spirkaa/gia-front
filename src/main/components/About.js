...
export const About = () => (
  <div>
    <Header header='О сайте' subHeader=' '/>
      <Row>
        <Col sm={1}>{' '}</Col>
        <Col sm={10}><h3>Сайт разработан с применением самых модных (клиент)
          и проверенных временем (сервер) технологий</h3></Col>
        <Col sm={1}>{' '}</Col>
      </Row>
      <Row>
        <Col sm={1}>{''}</Col>
      ...
      <Row>
        ...
        <Col sm={10}>
          ...
          <p>
            <strong>[v2.4.1 от 2019.06.09]</strong> - Дата экзамена теперь берется из HTML,
            а не из файла. Иногда в РЦОИ могут накосячить и вместо июня в первой строке файла оказывается май.
          </p>
          <p>
            <strong>[v2.4.0 от 2019.06.03]</strong> - На сервере обновлены версии Python, Django и пакетов.
            Восстановлена работа парсера. База очищена от неактуальных данных 2018 года.
          </p>
          <p>
          ...
          <p>
            <strong>[v2.3.0 от 2018.05.26]</strong> - Восстановлена работа парсера,
            база очищена от неактуальных данных и, соответственно, все подписки удалены.
          </p>
          <p>
          ...
          <p>
            <strong>[v2.2.3 от 2017.06.15]</strong> - Исправлена ошибка в функции обновления,
            когда в один день одновременно проходят экзамены 9 и 11 классов
            (19 июня, например).
          </p>
          <p>
            <strong>[v2.2.2 от 2017.06.13]</strong> - Чем дальше от начала ГИА,
            тем больше нужно было прокручивать выпадающий список дат на странице "Экзамены".
            Теперь даты сортируются в обратном порядке.
          </p>
          <p>
            <strong>[v2.2.1 от 2017.06.08]</strong> - Ограничено максимальное число подписок для одного аккаунта - 100
          </p>
          <p>
            <strong>[v2.2.0 от 2017.06.07]</strong> - Новая функция: подписка на уведомления о новых добавленных экзаменах
          </p>
          <p>
            <strong>[v2.1.0 от 2017.06.01]</strong> - Новая функция: регистрация и авторизация
          </p>
          <p>
            <strong>[v2.0.2 от 2017.05.28]</strong> - Функция обновледния БД стала умнее и теперь сравнивает
            заголовок Last-Modified каждого файла, чтобы не грузить то, что уже было загружено.
          </p>
          <p>
            <strong>[v2.0.1 от 2017.05.26]</strong> - РЦОИ внезапно выкатил новую версию сайта.
            Если раньше ссылки на все файлы были на одной странице,
          ...
          <p>
            <strong>[v2.0.0 от 2017.05.17]</strong> - Обновление перед началом основного периода 2016/2017:
          </p>
          <ul>
