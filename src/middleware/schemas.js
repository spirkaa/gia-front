...
const datePageSchema = new schema.Entity(
  "datePage",
  { results: new schema.Array(dateSchema) },
  { idAttribute: generateSlug },
)
const levelPageSchema = new schema.Entity(
  "levelPage",
  { results: new schema.Array(levelSchema) },
  { idAttribute: generateSlug },
)
const empPageSchema = new schema.Entity(
  "empPage",
  { results: new schema.Array(employeeSchema) },
  { idAttribute: generateSlug },
)
const examPageSchema = new schema.Entity(
  "examPage",
  { results: new schema.Array(examSchema) },
  { idAttribute: generateSlug },
)
const orgPageSchema = new schema.Entity(
  "orgPage",
  { results: new schema.Array(organisationSchema) },
  { idAttribute: generateSlug },
)
const placesPageSchema = new schema.Entity(
  "placesPage",
  { results: new schema.Array(placeSchema) },
  { idAttribute: generateSlug },
)
const dataSourcePageSchema = new schema.Entity(
  "dataSourcePage",
  { results: new schema.Array(dataSourceSchema) },
  { idAttribute: generateSlug },
)
const subsPageSchema = new schema.Entity(
  "subsPage",
  { results: new schema.Array(subsSchema) },
  { idAttribute: generateSlug },
)
