...
export const placesFilterSet = (filter) =>
  actionWithPayload(PLACES_FILTER_SET, filter)

export const placesFilterClearPages = () =>
  actionTrigger(PLACES_FILTER_CLEAR_PAGES)

export const placesPageSet = (page) =>
  actionWithPayload(PLACES_PAGE_SET, page)
