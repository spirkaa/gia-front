...
export const modalShow = () => actionTrigger(c.AUTH_MODAL_SHOW)

export const modalHide = () => actionTrigger(c.AUTH_MODAL_HIDE)

export const authLoginMsgRemove = () => actionTrigger(c.AUTH_LOGIN_MSG_CLEAR)
...
export const authRegistrationMsgRemove = () => actionTrigger(c.AUTH_REG_MSG_CLEAR)

export const authInfoUpdateMsgRemove = () => actionTrigger(c.AUTH_INFO_UPDATE_MSG_CLEAR)
...
export const authLogout = () => actionTrigger(c.AUTH_LOGOUT)

export const authRememberMe = (checked) => actionWithPayload(c.AUTH_REMEMBER, checked)

export const tokenSave = (token) => actionWithPayload(c.AUTH_TOKEN_SAVE, token)
...
export function authLogin(email, password) {
  return authApi({
    types: [c.AUTH_LOGIN_REQUEST, c.AUTH_LOGIN_SUCCESS, c.AUTH_LOGIN_FAILURE],
    endpoint: "auth/login/",
    data: { email, password },
    method: "POST",
  })
...
export function authInfo(jwt) {
  return authApi({
    types: [c.AUTH_INFO_REQUEST, c.AUTH_INFO_SUCCESS, c.AUTH_INFO_FAILURE],
    endpoint: "auth/user/",
    data: { jwt },
    method: "GET",
  })
...
export function authRegistration(email, password1, password2) {
  return authApi({
    types: [c.AUTH_REG_REQUEST, c.AUTH_REG_SUCCESS, c.AUTH_REG_FAILURE],
