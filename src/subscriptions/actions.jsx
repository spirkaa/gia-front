...
export function subsLoad(jwt, id = 1) {
  return loadThis({
    id: id,
    source: "subsPage",
    types: [c.SUBS_REQUEST, c.SUBS_SUCCESS, c.SUBS_FAILURE],
...
export function subsAdd(jwt, employee) {
  return authApi({
    types: [c.SUBS_ADD_REQUEST, c.SUBS_ADD_SUCCESS, c.SUBS_ADD_FAILURE],
...
export function subsDel(jwt, sub) {
  return authApi({
    types: [c.SUBS_DEL_REQUEST, c.SUBS_DEL_SUCCESS, c.SUBS_DEL_FAILURE],
...
export const subsClearPages = () => actionTrigger(c.SUBS_CLEAR_PAGES)

export const subsPageSet = (page) => actionWithPayload(c.SUBS_PAGE_SET, page)
