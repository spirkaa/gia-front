...
export const orgFilterClearPages = () =>
  actionTrigger(ORGANISATIONS_FILTER_CLEAR_PAGES)

export const orgPageSet = (page) =>
  actionWithPayload(ORGANISATIONS_PAGE_SET, page)
