...
import { ORGANISATIONS_PAGE_SET } from "../actions"
...
describe("organisations Pagination container", () => {
  beforeEach(() => {
    vi.stubGlobal(
      "fetch",
      vi.fn(() =>
  ...
  it("dispatches page set and load on page click", async () => {
    ...
    const state = makeState({
      entities: { orgPage: { 1: { count: 150, results: [] } } },
    })
    ...
    expect(call.endpoint).toBe("organisation/?search=&page=2")
    expect(store.getState().pagination.orgActivePage).toBe(2)
  })
